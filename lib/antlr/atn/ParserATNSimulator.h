...
namespace atn {
  ...
  protected:
    ...
    /// returns <seealso cref="#ANTLR_ERROR"/>. </returns>
     ...
     * {@link #ANTLR_ERROR} state was reached during ATN simulation.
     *
     * <p>
     ...
     * the {@link #ANTLR_ERROR} state was reached
    ...
    /// <p/>
    /// If {@code D} is <seealso cref="#ANTLR_ERROR"/>, this method returns <seealso cref="#ANTLR_ERROR"/> and

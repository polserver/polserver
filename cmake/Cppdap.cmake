...
set (CPPDAP_VERSION_REF "eeca5ce")
...
if(NOT EXISTS ${CPPDAP_LIB})
  ExternalProject_Add(cppdap
    ...
    PREFIX           cppdap
    LIST_SEPARATOR |
    CMAKE_ARGS       ${CPPDAP_FLAGS} -DCMAKE_INSTALL_PREFIX=${CPPDAP_INSTALL_DIR} -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER} -DCMAKE_C_COMPILER=${CMAKE_C_COMPILER} -DCMAKE_OSX_ARCHITECTURES=${PIPED_OSX_ARCHITECTURES}

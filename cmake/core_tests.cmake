...
# first test run
# 3.8, because the test client runs on asyncio: asyncio.run and the stream API it is
# built on are what set the floor. A python below that disables the client rather than
# failing the build, so the rest of the shard test still runs.
...
if (${Python3_FOUND})
  add_test(NAME shard_test_roundtrip
    COMMAND ${CMAKE_COMMAND}
      -Dpol=$<TARGET_FILE:pol>
      -Dtestdir=${CMAKE_CURRENT_SOURCE_DIR}/testsuite
  ...
  set_tests_properties( shard_test_roundtrip PROPERTIES FIXTURES_REQUIRED "client;shard;uoconvert;ecompile;shard_test")
  set_tests_properties( shard_test_roundtrip PROPERTIES DEPENDS shard_test_2)
endif()

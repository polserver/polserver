...
if(NOT EXISTS "${BOOST_SOURCE_DIR}/boost")
  ExternalProject_Add(boost
    ...
    CONFIGURE_COMMAND ${BOOTSTRAP_CONFIGURE_COMMAND}
    INSTALL_COMMAND ""
    # BUILD_COMMAND ""
    BUILD_COMMAND ${BOOTSTRAP_CONFIGURE_COMMAND} link=static variant=release runtime-link=static address-model=${ARCH_BITS} --with-filesystem stage

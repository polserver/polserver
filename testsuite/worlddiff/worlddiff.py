...
# rework of the zone insert/erase helpers reordering them. Both files are split now, so that
# signal is gone and nothing here replaces it. A change to the zone bookkeeping needs its own
# coverage; do not assume a green round trip covers it.
#

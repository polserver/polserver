...
class IndexUnpacking;
class IntegerValue;
class InterpolateString;
class JumpStatement;
class MemberAccess;
class MemberUnpacking;
class MethodCall;
...
public:
  ...
  virtual void visit_index_unpacking( IndexUnpacking& );
  ...
  virtual void visit_member_unpacking( MemberUnpacking& );

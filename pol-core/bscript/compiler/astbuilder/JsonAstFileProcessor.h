...
public:
  ...
  // antlrcpp::Any visitConstantDeclaration(EscriptGrammar::EscriptParser::ConstantDeclarationContext *ctx) override;
...
private:
  ...
  antlrcpp::Any make_function_call( EscriptGrammar::EscriptParser::FunctionCallContext*,

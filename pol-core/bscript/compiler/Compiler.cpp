                                                      ...
                                                      bool is_module )
{
  ...
  std::unique_ptr<CompilerWorkspace> workspace =
      build_workspace( pathname, report, is_module, true );
  if ( workspace )
  {
    register_constants( *workspace, report );
    optimize( *workspace, report );
                                                              ...
                                                              bool is_diagnostics_mode )
{
  ...
  auto workspace =
      is_module ? workspace_builder.build_module( pathname, is_diagnostics_mode )
                : workspace_builder.build( pathname, user_function_inclusion, is_diagnostics_mode );

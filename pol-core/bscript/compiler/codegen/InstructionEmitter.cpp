...
{
  emit_token( v.global ? TOK_GLOBALVAR : TOK_LOCALVAR, TYP_OPERAND, v.index );
}
...
{
  auto token_id = v.global ? INS_ASSIGN_GLOBALVAR : INS_ASSIGN_LOCALVAR;
...
{
  emit_token( v.global ? RSV_GLOBAL : RSV_LOCAL, TYP_RESERVED, v.index );
}

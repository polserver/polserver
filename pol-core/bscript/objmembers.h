...
enum MemberID
{
  ...
  MBR_MAXHP_MOD,
  MBR_MAXHP,    // 90
  MBR_DMG_MOD,  // weapon  // to be made redundant in the future
  MBR_ATTRIBUTE,
  MBR_INTRINSIC,
  MBR_HITSCRIPT,
  MBR_AR_BASE,  // 95
  ...
  MBR_STACKABLE,
  MBR_MOVEMODE,  // 135
  MBR_HITCHANCE_MOD,  // to be made redundant in the future
  ...
  MBR_MAX_WEIGHT_MOD,
  MBR_MAX_SLOTS_MOD,
  MBR_SPEED_MOD,  // to be made redundant in the future
  MBR_NAME_SUFFIX,
  ...
  MBR_LOWER_REAG_COST,  // 220
  MBR_SPELL_DAMAGE_INCREASE,
  MBR_FASTER_CASTING,
  MBR_FASTER_CAST_RECOVERY,
  MBR_DEFENCE_CHANCE_INCREASE,
  MBR_DEFENCE_CHANCE_INCREASE_CAP,  // 225
  MBR_LOWER_MANA_COST,
  MBR_FIRE_RESIST_CAP,
  MBR_COLD_RESIST_CAP,
  MBR_ENERGY_RESIST_CAP,
  MBR_POISON_RESIST_CAP,  // 230
  MBR_PHYSICAL_RESIST_CAP,
  MBR_DAMAGE_INCREASE,
  MBR_HIT_CHANCE,
  MBR_SWING_SPEED,
  MBR_LOWER_REAG_COST_MOD,  // 235
  MBR_SPELL_DAMAGE_INCREASE_MOD,
  MBR_FASTER_CASTING_MOD,
  MBR_FASTER_CAST_RECOVERY_MOD,
  MBR_DEFENCE_CHANCE_INCREASE_MOD,
  MBR_DEFENCE_CHANCE_INCREASE_CAP_MOD,  // 240
  MBR_LOWER_MANA_COST_MOD,
  MBR_FIRE_RESIST_CAP_MOD,
  MBR_COLD_RESIST_CAP_MOD,
  MBR_ENERGY_RESIST_CAP_MOD,
  MBR_POISON_RESIST_CAP_MOD,  // 245
  MBR_PHYSICAL_RESIST_CAP_MOD,
  MBR_DAMAGE_INCREASE_MOD,
  MBR_SWING_SPEED_MOD,
  MBR_LUCK_MOD,
  MBR_HIT_CHANCE_MOD,  //  250

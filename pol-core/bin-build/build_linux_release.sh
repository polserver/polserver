...
tar -cvf $DEST_TAR_FILE pol uoconvert uotool lib/lib*.so scripts/* config/*.cfg core-changes.txt uoconvert.txt uoconvert.cfg packethooks.txt packets.zip

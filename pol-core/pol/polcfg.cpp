...
void PolConfig::read_pol_config( bool initial_load )
{
  ...
  Plib::systemstate.config.show_warning_gump = elem.remove_bool( "ShowWarningGump", false );
  Plib::systemstate.config.show_warning_item = elem.remove_bool( "ShowWarningItem", false );

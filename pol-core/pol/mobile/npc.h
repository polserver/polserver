...
public:
  ...
  void on_pc_spoke_unicode( Character* src_chr, const char* speech, u8 texttype, const u16* wspeech,
                            const char lang[4], Bscript::ObjArray* speechtokens = nullptr );
  void on_ghost_pc_spoke_unicode( Character* src_chr, const char* speech, u8 texttype,

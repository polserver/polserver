  ...
  namespace Items {
	...
	BObjectImp* Item::get_script_member_id( const int id ) const
	{
	  ...
	  switch ( id )
	  {
		...
		case MBR_FIRE_RESIST: return new BLong( calc_element_resist( Core::ELEMENTAL_FIRE ) ); break;
		case MBR_COLD_RESIST: return new BLong( calc_element_resist( Core::ELEMENTAL_COLD ) ); break;

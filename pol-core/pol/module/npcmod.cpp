...
TmplExecutorModule<NPCExecutorModule>::FunctionTable
    TmplExecutorModule<NPCExecutorModule>::function_table = {
        ...
        {"RunToward", &NPCExecutorModule::mf_RunToward, UINT_MAX},
        {"WalkAwayFrom", &NPCExecutorModule::mf_WalkAwayFrom, UINT_MAX},
        {"RunAwayFrom", &NPCExecutorModule::mf_RunAwayFrom, UINT_MAX},
        {"TurnToward", &NPCExecutorModule::mf_TurnToward, UINT_MAX},
        {"TurnAwayFrom", &NPCExecutorModule::mf_TurnAwayFrom, UINT_MAX},

        {"WalkTowardLocation", &NPCExecutorModule::mf_WalkTowardLocation, UINT_MAX},
        {"RunTowardLocation", &NPCExecutorModule::mf_RunTowardLocation, UINT_MAX},
        {"WalkAwayFromLocation", &NPCExecutorModule::mf_WalkAwayFromLocation, UINT_MAX},
        {"RunAwayFromLocation", &NPCExecutorModule::mf_RunAwayFromLocation, UINT_MAX},
        {"TurnTowardLocation", &NPCExecutorModule::mf_TurnTowardLocation, UINT_MAX},
        {"TurnAwayFromLocation", &NPCExecutorModule::mf_TurnAwayFromLocation, UINT_MAX},

        {"say", &NPCExecutorModule::say, UINT_MAX},
        {"SayUC", &NPCExecutorModule::SayUC, UINT_MAX},
        {"SetOpponent", &NPCExecutorModule::mf_SetOpponent, UINT_MAX},
        {"SetWarMode", &NPCExecutorModule::mf_SetWarMode, UINT_MAX},
        {"SetAnchor", &NPCExecutorModule::mf_SetAnchor, UINT_MAX},
        {"position", &NPCExecutorModule::position, UINT_MAX},
        {"facing", &NPCExecutorModule::facing, UINT_MAX},
        {"IsLegalMove", &NPCExecutorModule::IsLegalMove, UINT_MAX},
        {"CanMove", &NPCExecutorModule::CanMove, UINT_MAX},
        {"getproperty", &NPCExecutorModule::getproperty, UINT_MAX},
        {"setproperty", &NPCExecutorModule::setproperty, UINT_MAX},
        {"makeboundingbox", &NPCExecutorModule::makeboundingbox, UINT_MAX}

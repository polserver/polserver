...
#define MESSAGE_HANDLER( type, func ) \
  PacketRegistry::set_handler( type##_ID, sizeof( type ), reinterpret_cast<Network::PktHandlerFunc>( func ), Network::PacketVersion::V1 )

#define MESSAGE_HANDLER_VARLEN( type, func ) \
  PacketRegistry::set_handler( type##_ID, MSGLEN_2BYTELEN_DATA, (Network::PktHandlerFunc) func, Network::PacketVersion::V1 )

#define MESSAGE_HANDLER_V2( type, func ) \
  PacketRegistry::set_handler( type##_ID, sizeof( type ), reinterpret_cast<Network::PktHandlerFunc>( func ), Network::PacketVersion::V2 )

#define MESSAGE_HANDLER_VARLEN_V2( type, func ) \
  PacketRegistry::set_handler( type##_ID, MSGLEN_2BYTELEN_DATA, (Network::PktHandlerFunc) func, Network::PacketVersion::V2 )

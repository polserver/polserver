...
public:
  ...
  virtual inline u8 getID() const POL_OVERRIDE
  {
    return ID;
  };
  virtual inline u16 getSize() const POL_OVERRIDE
  {
    return SIZE;
  };
  virtual size_t estimateSize() const POL_OVERRIDE
  {
    return SIZE + sizeof(PacketInterface);
  };
...
public:
  ...
  virtual inline u16 getSubID() const POL_OVERRIDE
  {
    return _sub;
  };
};

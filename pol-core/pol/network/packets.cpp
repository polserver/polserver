	  ...
	  PacketInterface* GetPacket( u8 id, u16 sub )
	  {
		...
		switch (id)
		{
		  ...
		  case PKTBI_BF_ID:
		  {
			switch ( sub )
			{
			  case Core::PKTBI_BF::TYPE_CLOSE_GUMP:					return new PktOut_BF_Sub4();
			  ...
			  case Core::PKTBI_BF::TYPE_NEW_SPELLBOOK:				return new PktOut_BF_Sub1B();
			  case Core::PKTBI_BF::TYPE_CUSTOM_HOUSE_SHORT:			return new PktOut_BF_Sub1D();

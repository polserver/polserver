...
constexpr u8 PKTOUT_F3_TYPE_ITEM = 0x0;
constexpr u8 PKTOUT_F3_TYPE_CHAR = 0x1;
constexpr u8 PKTOUT_F3_TYPE_MULTI = 0x2;
constexpr u8 PKTOUT_F3_TYPE_ATTACKABLE = 0x3;
}  // namespace Pol::Core

...
#define MAX_STATICS_PER_BLOCK 10000
  ...
  namespace Core {
	...
	*/
	...
	Multi::UMulti* uo_find_supporting_multi( unsigned short x, unsigned short y, short z );

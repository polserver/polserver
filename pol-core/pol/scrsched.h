...
using StartScriptCallback = std::function<void( Bscript::BObjectImp* )>;

template <typename... Args>
void start_script( const char* filename, Args... args );

template <typename... Args>
void start_script_callback( const char* filename, StartScriptCallback callback, Args... args );
...
class RunScriptImpl
{
  ...
  template <typename... Args>
  friend void Core::start_script_callback( const char* filename, StartScriptCallback callback,
                                           Args... args );
  ...
  static void start_script_callback( const char* filename, StartScriptCallback callback,
                                     const std::initializer_list<Bscript::BObjectImp*>& args );
...
void start_script_callback( const char* filename, StartScriptCallback callback, Args... args )
{
  RunScriptImpl::start_script_callback( filename, callback,

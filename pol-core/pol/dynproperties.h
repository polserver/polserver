...
enum DynPropTypes : u8
{
  ...
  PROP_MIN_ATTACK_RANGE_INCREASE = 92,        // UObject
  PROP_MIN_ATTACK_RANGE_INCREASE_MOD = 93,   // UObject
  PROP_ORIG_MIN_ATTACK_RANGE_INCREASE = 94,  // Npc
  PROP_MAX_ATTACK_RANGE_INCREASE = 95,       // UObject
  PROP_MAX_ATTACK_RANGE_INCREASE_MOD = 96,   // UObject
  PROP_ORIG_MAX_ATTACK_RANGE_INCREASE = 97,   // Npc

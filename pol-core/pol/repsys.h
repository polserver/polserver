...
private:
  ...
  static unsigned char hilite_color_idx( const Mobile::Character* chr,
                                         const Mobile::Character* who );
  static unsigned short name_color( const Mobile::Character* seen_by,
                                    const Mobile::Character* who );

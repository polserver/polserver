...
"",
"#",
"# TitlePrefixSeparator / TitleSuffixSeparator / TitleRaceSeparator / TitleGuildSeparator",
"# Strings the core inserts around a mobile's displayed title on the paperdoll and",
"# AOS tooltip: between title_prefix and name, between name and title_suffix, and",
"# before the (race) and [guild] parts. Each defaults to a single space. Set empty",
"# to let the title_prefix/title_suffix strings carry their own separator. Quote the",
"# value to include spaces, e.g. TitleSuffixSeparator \", \"",
"#",
...
"#",
"# DefaultVisualRange",
"# distance at which player can see information around his surroundings.",
"# Keep in mind this value needs to be same as client as there are assumptions made based on it whether client",
"# can still see an object or not as client will automatically remove objects out of its configured range.",
"# Default is 18 (1-255 allowed)",
"DefaultVisualRange=18",
"",
"#",
"# AllowVisualRangeModification",
"# if active allows clients to modify their LOS between Minimum and MaximumVisualRange",
"# Default 0",
"AllowVisualRangeModification=0",
"",
"#",
"# MinimumVisualRange",
"# defines the minimum visual range a client can set",
"# Default 5",
"MinimumVisualRange=5",
"",
"#",
"# MaximumVisualRange",
"# defines the maximum visual range a client can set",
"# Default 24",
"MaximumVisualRange=24",
"",
...
"# 0x100 = Elvem race",
"# 0x200 = unknown",
"# 0x400 = send client type",
"# 0x800 = unknown",
"# 0x1000 = 7th char slot",
"# 0x2000 = unknown",
"# 0x4000 = new movement pkts",
...
"#",
"# DefaultExpansion",
"# default expansion for accounts",
"# supported values T2A(default),LBR,AOS,SE,ML,KR,SA,HSA,TOL",
...
"#",
"# MasterCanClotheNPCs",
"# If enabled, the core will allow a master to clothe his followers.",
"# Default is 0",
"MasterCanClotheNPCs=0",
"",
"#",
"# MasterCanAccessNPCsBackpack",
"# If enabled, the core will allow a master to access (ie. use, move, target) his followers' backpack and",
"# the items within it.",
"# Default is 0",
"MasterCanAccessNPCsBackpack=0",
"",
"#",

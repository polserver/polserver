...
"# Strings inserted around a mobile's displayed title on the paperdoll and AOS tooltip,",
"# each only when its title part is set: before/after the name and before the (race) and",
"# [guild] parts. [guild] is AOS tooltip only. Default is a single space; quote a value",
"# to keep spaces, or set it empty (e.g. TitleSuffixSeparator=\"\") to let the title",
"# strings carry their own separator.",
"#",

...
BOOL WINAPI control_handler( DWORD dwCtrlType )
{
  ...
  case CTRL_C_EVENT:      // SERVICE_CONTROL_STOP in debug mode
    ERROR_PRINTLN( "Ctrl-C detected.  Stopping..." );
    signal_exit();
    return TRUE;
...
// Consider these three new signals?
    ...
    case CTRL_CLOSE_EVENT:    // console window closing
          ERROR_PRINTLN("Console window closing. Stopping...");
      signal_exit();
      return TRUE;

    case CTRL_LOGOFF_EVENT:    // User logging off system
          ERROR_PRINTLN("User logging off system. Stopping...");
      signal_exit();
      return TRUE;

    case CTRL_SHUTDOWN_EVENT:  // User shutting down system
          ERROR_PRINTLN("System shutting down. Stopping...");
      signal_exit();
      return TRUE;
#endif
  }

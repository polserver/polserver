...
public:
  ...
  {
    debug_flyweight_queries.push_back( this );
  }
  ...
  virtual size_type bucket_count()const POL_OVERRIDE
  {
    return cont.bucket_count();
  }
  virtual size_type max_bucket_count()const POL_OVERRIDE
  {
    return cont.max_bucket_count();
  }
  virtual size_type bucket_size( size_type n )const POL_OVERRIDE
  {

...
SendSysMessageCL( character, cliloc_num, uc_text:=string, font:=_DEFAULT_CLFONT , color:=_DEFAULT_CLCOLOR);

PrintTextAboveCL( character, cliloc_num, uc_text:=string, font:=_DEFAULT_CLFONT , color:=_DEFAULT_CLCOLOR);

// Object : Object text is to appear over.
PrintTextAbovePrivateCL( character, object, cliloc_num, uc_text:=string, font:=_DEFAULT_CLFONT , color:=_DEFAULT_CLCOLOR);
